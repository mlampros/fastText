...
- **Lampros Mouselimis**. Author, maintainer.
  [](https://orcid.org/https://orcid.org/0000-0002-8024-1546)
...
Source:
[`inst/CITATION`](https://github.com/mlampros/fastText/blob/master/inst/CITATION)
...
1.0.8, <https://CRAN.R-project.org/package=fastText>.
...
Facebook I (2016). *fastText: Library for fast text representation and
classification*. <https://github.com/facebookresearch/fastText>.
...
Bojanowski P, Grave E, Joulin A, Mikolov T (2017). “Bag of Tricks for
...
Linguistics: Volume 2, Short Papers*, 427–431.
...
Bojanowski P, Grave E, Joulin A, Mikolov T, Douze M, Jegou H (2016).
